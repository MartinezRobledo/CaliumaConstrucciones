...
<style>
  *{margin: 0;padding: 0;box-sizing: border-box;font-family: sans-serif;text-decoration: none;list-style: none;}
...
body{
    background: linear-gradient(white, rgb(0, 103, 123));
